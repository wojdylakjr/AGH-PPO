...
const Matrix* form_Matrix(int a=3, int b=3, int c=0);//funkcja tworzaca domyslna macierz, zwraca macierz, przyjmuje argumenty domniemane, pierwszy to rozmar, drugi to rozmiar skladowych tablic; trzeci domyslne wypelnienie
void print(Vector&);
